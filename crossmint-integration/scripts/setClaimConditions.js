...
async function setClaimConditions() {
    const sdk = new ThirdwebSDK("polygon", {
        secretKey: "NJnQPQRiVMIoPSu4Ylvb1eY6dKo2xBr-S-UIzlDNqriK0h9L36DvYHO5uQwqNPIXntvKfDVCbGx7MtINrlNX0w", // Get from Thirdweb dashboard
    });
